...
const Form = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["render", _sfc_render$1], ["__scopeId", "data-v-948b34b9"]]);
const _sfc_main = {
  methods: {
    openFormWindow() {
      console.log("HEY LE BUTTON EST CLICKE");
      window.api.send("open-form-window", "Ouvrir la fenêtre de formulaire");
    }
  }
};
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", null, [
    _cache[1] || (_cache[1] = createBaseVNode("h1", null, "Bienvenue sur la page d'accueil", -1)),
    createBaseVNode("button", {
