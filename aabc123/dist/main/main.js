...
var Niveau = /* @__PURE__ */ ((Niveau2) => {
  ...
  Niveau2["Intermediare"] = "Intermediaire";
...
electron.app.on("ready", async () => {
  ...
  try {
    ...
    electron.dialog.showErrorBox("Erreur de connexion", "Impossible de se connecté à la BD. Vérifiez que Mysql est en cours d'exécution");
    electron.app.quit();
    return;
  }
...
electron.ipcMain.handle("Canal-Supprimer-Participant", async (_event, matricule) => {
  try {
